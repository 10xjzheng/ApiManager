...
<div class="site-login">
    ...
    'inputOptions' => ['placeholder' => $model->getAttributeLabel('方法名称'),],])->label(false)->textInput(['autofocus' => true]) ?>
    <?= $form->field($model, 'apiDiscribe',[
    'inputTemplate' => '<div class="input-group"><span class="input-group-addon">接口描述</span>{input}</div>',
    'inputOptions' => ['placeholder' => $model->getAttributeLabel('接口描述'),],])->label(false)->textInput(['autofocus' => true]) ?>
